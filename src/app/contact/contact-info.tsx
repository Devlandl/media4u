...
const contactMethods = [
  {
    ...
    label: "Email",
    value: "hello@media4u.fun",
    href: "mailto:hello@media4u.fun",
  },
  {
    icon: (
...
const socialLinks = [
  {
    name: "Twitter",
    href: "https://twitter.com/media4u",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/media4u",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/media4u",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
